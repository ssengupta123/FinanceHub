...
export async function seedDatabase() {
  ...
  await db("milestones").insert([
    { project_id: projIds[0], name: "Requirements Sign-off", due_date: "2025-09-30", completed_date: "2025-09-28", status: "completed", amount: "200000.00" },
    { project_id: projIds[0], name: "Phase 1 Delivery", due_date: "2026-01-31", completed_date: "2026-01-29", status: "completed", amount: "400000.00" },
    { project_id: projIds[0], name: "Phase 2 Delivery", due_date: "2026-06-30", status: "pending", amount: "500000.00" },
    { project_id: projIds[0], name: "UAT Completion", due_date: "2026-10-31", status: "pending", amount: "400000.00" },
    { project_id: projIds[1], name: "Discovery Workshop", due_date: "2025-11-15", completed_date: "2025-11-14", status: "completed", amount: "72000.00" },
    { project_id: projIds[1], name: "System Design Approval", due_date: "2026-01-15", completed_date: null, status: "overdue", amount: "144000.00" },
    { project_id: projIds[1], name: "Integration Go-Live", due_date: "2026-07-31", status: "pending", amount: "288000.00" },
    { project_id: projIds[2], name: "Q1 Analytics Report", due_date: "2025-06-30", completed_date: "2025-06-28", status: "completed", amount: "125000.00" },
    { project_id: projIds[2], name: "Q2 Analytics Report", due_date: "2025-12-31", completed_date: null, status: "overdue", amount: "125000.00" },
    { project_id: projIds[2], name: "Q3 Analytics Report", due_date: "2026-03-31", status: "pending", amount: "125000.00" },
    { project_id: projIds[3], name: "Migration Complete", due_date: "2025-10-31", completed_date: "2025-10-28", status: "completed", amount: "310000.00" },
    { project_id: projIds[4], name: "Project Charter Approval", due_date: "2026-03-15", status: "pending", amount: "105000.00" },
  ]);
